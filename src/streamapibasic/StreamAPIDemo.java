...
import streamapibasic.model.Specialist;
import streamapibasic.model.Specialty;
import streamapibasic.util.OldApproachUtil;
import streamapibasic.util.StreamAPIUtil;

import java.math.BigDecimal;
import java.util.List;
import java.util.Map;

import static streamapibasic.util.StreamAPIUtil.*;
